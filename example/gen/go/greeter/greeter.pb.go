...
const file_greeter_greeter_proto_rawDesc = "" +
	...
	"\x1cTestTypesReadPostPathAllowed\x12\x1d.greeter.TestTypesReadRequest\x1a\x16.google.protobuf.Empty\"%\x82\xd3\xe4\x93\x02\x1f\"\x1d/api/v1/test/types/{str}/:i64\x12r\n" +
	"\x17TestEnumTypesQueryPrams\x12\x1d.greeter.TestTypesReadRequest\x1a\x16.google.protobuf.Empty\" \x82\xd3\xe4\x93\x02\x1a\x12\x18/api/v1/test/types/{str}\x12^\n" +
	"\n" +
...
var file_greeter_greeter_proto_depIdxs = []int32{
	...
	4, // 7: greeter.GreeterService.TestEnumTypesQueryPrams:input_type -> greeter.TestTypesReadRequest
	...
	8, // 14: greeter.GreeterService.TestEnumTypesQueryPrams:output_type -> google.protobuf.Empty
	6, // 15: greeter.GreeterService.CreateUser:output_type -> greeter.CreateUserResponse
